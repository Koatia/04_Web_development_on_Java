...
/**
 * Класс описывающий работу графического интерфейса приложения. Является абстракцией GUI
 */
public class ClientGUI extends JFrame implements InterfaceClientView {
    ...
    /**
     * Контроллер, описывающий реакцию на различные события. Когда что-то происходит, например нажата какая-то кнопка на
     * экране, то обращаемся к контроллеру и вызываем нужный метод
     */
