package animation_test.draw_pic.sprites;

import animation_test.common.MainCanvas;
import animation_test.common.Sprite;
...
public class Picture extends Sprite {
    ...
    public Picture(int x, int y) {
        ...
        halfWidth = 62;
        try {
            image = ImageIO.read(new File("src/animation_test/draw_pic/resource/picachu.png"));
        } catch (IOException e) {
