...
public class Program {
     ...
     * Задача 1 ========
     * <p>
     * Используя SQL, создайте таблицу students с полями id (ключ), name, и age. Реализация подключения к базе данных
     * через JDBC: Напишите Java-код для подключения к базе данных (например, MySQL или PostgreSQL). Реализуйте вставку,
     * чтение, обновление и удаление данных в таблице Students с использованием провайдера JDBC.
     */

    public static void main(String[] args) {
        String url = "jdbc:mysql://studentsDB:3306/";
        String user = "root";
